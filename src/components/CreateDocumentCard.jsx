...
const CreateDocumentCard = () => {
    ...
    return (
        <div onClick={onClick} className='bg-neutral-800 flex items-center justify-center rounded-md flex-col border border-slate-300 transition-opacity opacity-40 hover:opacity-100 hover:cursor-pointer w-[250px]'>
